                                ...
                                <div>
                                    <div id="container">
                                                        ...
                                                        <li>
                                                            ...
                                                            <section class="list-right">
                                                                ...
                                                                <?php if ($article['status']==2): ?>
                                                                    ...
                                                                    <span data-page="<?php echo $page ?>"
                                                                          data-id="<?php echo $article['id'] ?>" data-status='1' class="label label-success" onclick="return Status.changeIt(event,this);">Опубликовать</span>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <h1>Пока нет ни одного объявления</h1>
                                            <br>
